                        ...
                        Rectangle {
                            ...
                            Image {
                                ...
                                source: {
                                    ...
                                    const fileType = String(fileList.selectedItem.fileType || "").toLowerCase()
                                    if (fileType.match(/^(jpg|jpeg|png|gif|bmp)$/)) {
                                        return "file:///" + fileList.selectedItem.filePath
                                    }
                                    return fileList.selectedItem.fileIcon || "qrc:/resources/images/file.svg"
                                }
                                asynchronous: true
                                cache: true
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                Label {
                                    ...
                                    font {
                                        ...
                                        bold: true
                                        pixelSize: style.defaultFontSize + 2
                                    }
                                    color: style.textColor
                                }
                            ...
                            Repeater {
                                model: [
                                    {
                                        label: "文件名", 
                                        value: fileList.selectedItem ? fileList.selectedItem.fileName || "-" : "-"
                                    },
                                    {
                                        label: "类型", 
                                        value: fileList.selectedItem ? fileList.selectedItem.fileType || "-" : "-"
                                    },
                                    {
                                        label: "大小", 
                                        value: fileList.selectedItem ? fileList.selectedItem.displaySize || "-" : "-"
                                    },
                                    {
                                        label: "修改时间", 
                                        value: fileList.selectedItem ? fileList.selectedItem.displayDate || "-" : "-"
                                    }
                                ]
                                ...
                                delegate: ColumnLayout {
                                    ...
                                    Label {
                                        ...
                                        color: style ? style.secondaryTextColor : "#666666"
                                    }
                                    ...
                                    Label {
                                        ...
                                        color: style ? style.textColor : "#202020"
                                        Layout.fillWidth: true
                            ...
                            ColumnLayout {
                                ...
                                Rectangle {
                                    ...
                                    Label {
                                        ...
                                        text: fileList.selectedItem ? fileList.selectedItem.filePath : "-"
                                        font.family: style.fontFamily
                                        font.pixelSize: style.defaultFontSize
                                        color: style.textColor
                                        wrapMode: Text.WrapAtWordBoundaryOrAnywhere
